...
\author{Ing. Iriarte Fernandez Nicolás Ezequiel} % Tu nombre, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \authorname

\director{Lic. Nicolás Eduardo Horro (INVAP)} % El nombre del director, se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \dirname
...
%%   \thispagestyle{empty}
%%   \vspace*{\fill}
%%   \textit{Esta página ha sido intencionalmente dejada en blanco y no forma parte de la memoria.}
%%   \textit{Es unicamente para mantener los capítulos de ejemplo.}
%%   \vspace*{\fill}
%% \end{center}
...
%% \include{Chapters/Chapter1_back}
%% \include{Chapters/Chapter2_back}
%% \include{Chapters/Chapter3_back}
%% \include{Chapters/Chapter4_back}
%% \include{Chapters/Chapter5_back}
